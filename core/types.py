"""
Data-loader types — each CameraIntrinsics and BBox3D are reused from v2.
...
class BBox3D:
    ...
    obb_R: np.ndarray = field(default_factory=lambda: np.eye(3))
...
# ---------------------------------------------------------------------------
# Per-frame output of the tracking generator
# ---------------------------------------------------------------------------
...
class TrackedFrame:
    ...
    # populated later by graph builder
    local_graph: Any = None
