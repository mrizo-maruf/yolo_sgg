...
scene_name = "fixed_nice_room"
sub = "_seq_1"
BACKGROUND_USD_PATH = f"/workspace/isaaclab/source/eval_scenes/nice_scene/fixed_nice_room.usd"

keyframes_move = [
    # nikita eval scenes 2
    # {'time': 0, 'translation': [0, -3, 2], 'euler_angles': [0, 10, 90]},
    # {'time': 10, 'translation': [0, 2, 2], 'euler_angles': [0, 10, 0]},
    # {'time': 40, 'translation': [3, 2, 2], 'euler_angles': [0, 10, -90]},
    # {'time': 60, 'translation': [3, -3, 2], 'euler_angles': [0, 10, -180]},
    # {'time': 90, 'translation': [-3, -3, 2], 'euler_angles': [0, 10, -270]},
    # {'time': 110, 'translation': [-3, 3, 2], 'euler_angles': [0, 10, -355]},
    
    {'time': 0, 'translation': [0, 1, 2], 'euler_angles': [0, 15, 50]},
    {'time': 40, 'translation': [0, 3, 2], 'euler_angles': [0, 25, -20]},
    {'time': 80, 'translation': [4, 3, 2], 'euler_angles': [0, 15, -45]},
    {'time': 100, 'translation': [4, 3, 2], 'euler_angles': [0, 15, 120]},
    {'time': 140, 'translation': [4, 0, 2], 'euler_angles': [0, 15, 45]},
    # {'time': 0, 'translation': [4, 0, 2], 'euler_angles': [0, 15, ]},
    {'time': 180, 'translation': [0, 1, 2], 'euler_angles': [0, 15, 180]},
    {'time': 220, 'translation': [2, 2, 2], 'euler_angles': [0, 15, 0]},
    {'time': 350, 'translation': [2, 2, 2], 'euler_angles': [0, 15, 355]},
]
...
# # Avoid tiled multi-GPU artifacts
settings.set("/renderer/multiGpu/enabled", False)
settings.set("/rtx/realtime/mgpu/enabled", False)
...
# ---------------------- Output Paths ----------------------
base_dir = f"/workspace/isaaclab/IsaacSimData/{scene_name + sub}/"
traj_dir = f"/workspace/isaaclab/IsaacSimData/{scene_name + sub}"
...
bbox3d_ann = rep.AnnotatorRegistry.get_annotator("bounding_box_3d")
bbox2d_ann = rep.AnnotatorRegistry.get_annotator("bounding_box_2d_tight")
for ann in [depth_ann, rgb_ann, seg_ann, bbox3d_ann, bbox2d_ann]:
    ann.attach([render_product_path])
...
while simulation_app.is_running():
    ...
    threed_bbox_data = bbox3d_ann.get_data()
    
    twod_bbox_data = bbox2d_ann.get_data()
